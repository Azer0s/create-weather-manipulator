...
- **Draw throttle:** the resistor also caps how much SU per tick the mod's own consumers (Weather Inducer, SU Charger) may pull through it: with a 1,024 SU resistor in the line, a full inducer charge takes 1,024 ticks instead of 8.
