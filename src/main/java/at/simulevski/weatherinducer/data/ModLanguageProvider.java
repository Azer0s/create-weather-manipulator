...
public class ModLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("weatherinducer.display_source.charger", "Charger Charge");
        add("weatherinducer.display_source.charger_network", "Charger Network");
        add("weatherinducer.display.charger.display", "Displayed Info");
        add("weatherinducer.display.charger.progress_bar", "Progress Bar");
        add("weatherinducer.display.charger.percent", "Percentage");
        add("weatherinducer.display.charger.current", "Stored SU-s");
        add("weatherinducer.display.charger.max", "Total Capacity");
        add("weatherinducer.display.charger.remaining", "Time Remaining");
